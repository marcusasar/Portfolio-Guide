...
| 🚗🔋⚡ [EV-Sales-Time-Series-Analysis](https://github.com/marcusasar/ev-sales-time-series-analysis) | Time Series Analysis | Data Analytics | Business Intelligence | In this project, I performed a comprehensive time series analysis on an electric vehicle (EV) sales dataset to uncover key business insights and trends. |
